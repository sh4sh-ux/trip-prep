...
## 현재 버전
**v0.26** (2026-08-06) — 메뉴별 묶음 보기(조리도구·소모품·재료를 한 화면에)까지 반영
...
- **장보기** — `메뉴 고르기`(칩, 짧게 눌러 담기/빼기 · 길게 눌러 묶음 보기) / `장볼 것`(매대별 아코디언 + 전체 접기/펼치기)
  - **메뉴별 묶음 보기**(`sheetMenuBundle`) — 한 메뉴에 필요한 것을 조리도구/소모품/재료 3그룹으로.
    장보기의 '매대별 합산'과 반대 시선("이 메뉴 한 상 차리려면?"). 오늘 탭의 그 날 메뉴 행 탭, 또는 장보기 칩 길게 눌러 진입.
...
| `mergeMarket(t)` | 메뉴 재료 합산 + overrides/excluded 적용 |
